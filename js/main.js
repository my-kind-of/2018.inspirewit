...
function constructor(person, i) {
  ...
  console.log("hello this is " + $(".js-person:last") );
...
function appendMe() {
  ...
  "<li class='js-info dn'>You are a designer, rebel, disruptor, engineer, programmer, technologist, strategist, inspiration, researcher, facilitator, advocate, <span class='b i'>role model.</span></li>" +
  "<li class='trans-soft js-triangle'><img class='center db' src='img/triangle.svg' alt=''></li></ul></div>"
